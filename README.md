...
I am a results-driven **IT Officer** with over **6+ years of experience** in the digital landscape. I specialize in **Mobile App & Web Development**, **Cybersecurity**, and **Cloud Infrastructures**.

My expertise lies in building highly scalable digital solutions and integrating state-of-the-art **Cloud-hosted AI systems** such as **Google Gemini**, **Amazon Bedrock**, and **Azure AI Foundry**. I bridge the gap between robust security protocols and next-generation, seamless user experiences.
...
<div align="center">
  ...
  <img src="https://img.shields.io/badge/Data%20Science-%233776AB.svg?style=for-the-badge&logo=python&logoColor=white" alt="Data Science" />
</div>

- **Mobile Development**: Expert in building high-performance, cross-platform apps using **Flutter**.
- **AI System Integration**: Implementing powerful Cloud-hosted AI solutions (Gemini, Bedrock, Azure AI Foundry).
- **Cybersecurity & PKI**: Specialized in securing enterprise infrastructures and implementing **Public Key Infrastructure**.
- **Cloud Services**: Proficient in **Azure**, **Firebase**, and scalable cloud architectures.
...
- 🤖 **AI System Integration**: Integrating state-of-the-art AI capabilities into existing platforms.
- 🛡️ **Cybersecurity & PKI Consulting**: Infrastructure auditing, PKI implementation, and data compliance.
